...
tunningValues <- tune(svm, readmitted ~ ., data = PatientData[trainingRows,], kernel = "linear", ranges = list(cost = c(0.001, 0.01, 0.1, 1, 5, 10, 100)))
summary(tunningValues)


predictions <- predict(AllDataSVMFit)
