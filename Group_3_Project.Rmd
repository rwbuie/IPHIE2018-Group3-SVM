...
set1FIT <- svm(readmitted ~ ., data = PatientData[trainingRows1,], kernel = "linear", cost = 1000, scale = FALSE)
summary(set1FIT)
...
Set1PredictionRadial <- predict(set1FITRadial, PatientData[testingRows1,], na.action = na.exclude)
